...
public class BluetoothLePlugin extends CordovaPlugin 
{
  ...
  { 
    ...
    if (bluetoothAdapter.isEnabled())
    {
      ...
      String ssidName = BluetoothAdapter.getDefaultAdapter().getName();
      String macAddress = BluetoothAdapter.getDefaultAdapter().getAddress();
      addProperty(returnObj, "ssidName", ssidName);
      addProperty(returnObj, "macAddress", macAddress);
      addProperty(returnObj, keyStatus, statusEnabled);
  ...
  private LeScanCallback scanCallback = new LeScanCallback()
  {
    ...
    public void onLeScan(final BluetoothDevice device, int rssi, byte[] scanRecord)
    {
      ...
      addProperty(returnObj, "deviceSSID", device.getName());

        // check if GPS enabled
      String latitude = String.valueOf(53.479347);
      String longitude = String.valueOf(-2.246017);
      addProperty(returnObj, "latitude", latitude);
      addProperty(returnObj, "longitude", longitude);
